...
function ProductCard(props: ProductCarcProps){
    ...
    return (
        <article className="border border-gray-200 rounded-lg overflow-hidden shadow-md bg-white w-64 flex flex-col mx-auto mb-6 m-2">
            <img className="w-full h-64 object-contain p-4" src={src} alt={title} />
            <div className="p-4 flex flex-col items-start">
                <h3 className="font-normal text-gray-700 mb-2 line-clamp-2">{title}</h3>
